...
import {
    getSingleElection,
    updateElection,
} from "../../context/ElectionAction";
import { Link, useNavigate, useParams } from "react-router-dom";
import Spinner from "../../components/Spinner";
import { toast } from "react-toastify";

function EditElectionPage() {
    const { loading, dispatch, message, election } =
    ...
    useEffect(() => {
        ...
        const getElection = async () => {
            const electionData = await getSingleElection(id);
            dispatch({
                type: "SHOW_ELECTION",
    ...
    const handleSubmit = async (e) => {
        ...
        if (
            ...
            const data = await updateElection(id, formData);

            if (data.success) {
                dispatch({ type: "UPDATE_ELECTION", payload: data });
